...
# Input file options
dataFile = 'getwfm1_parsed.txt' # Must be a text file
...
dataPlotFile = 'data_sc.png'
fitPlotFile = 'dfit_sc.png'
residualPlotFile = 'res_sc.png'
...
dataPlotOptions = cf.PlotOptions(title = "V vs. time - Data",
                                 xlabel = 'Time',
                                 ylabel = 'Voltage (V)')

# Fit Plot - shows data points with error bars and the fit line
fitPlotOptions = cf.PlotOptions(title = "V vs. time - Fit",
                                 xlabel = 'Time',
                                 ylabel = 'Voltage (V)')

# Residual Plot - shows residuals with error bars and a zero reference line
residualPlotOptions = cf.PlotOptions(title = "V vs. time - Residual",
                                 xlabel = 'Time',
                                 ylabel = 'Voltage (V)')
